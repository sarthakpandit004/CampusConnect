...
//             📦 CampusCrate Marketplace
//           </h1>
//           <p className="mt-2 text-sm text-gray-500">Discover, post, and trade items across your campus.</p>
//         </header>
...
//   className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm space-y-6 max-w-xl mx-auto"
// >
//   <h2 className="text-xl font-semibold text-gray-900">Post an Item</h2>
...
//       required
//       className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-500 transition"
//     />
//   </div>
...
//       required
//       rows={4}
//       className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md resize-none focus:outline-none focus:ring-1 focus:ring-gray-500 transition"
//     />
//   </div>
...
//       onChange={handleChange}
//       required
//       className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-1 focus:ring-gray-500 transition"
//     >
...
//     </div>
//     <div>
//       <label className="block text-sm font-medium text-gray-800 mb-1">Contact</label>
//       <input
//         type="text"
//         name="contact"
...
//   <div>
//     <label className="block text-sm font-medium text-gray-800 mb-1">Upload File</label>
//     <input
//       type="file"
//       accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf, image/*"
//       onChange={(e) => setFile(e.target.files[0])}
//       className="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-black file:text-white hover:file:bg-gray-900 cursor-pointer"
//     />
//   </div>
...
//     <button
//       type="submit"
//       className="bg-black text-white text-sm font-medium px-5 py-2 rounded-md hover:bg-gray-900 transition"
//     >
//       Post Item
//     </button>
//   </div>
...
//           <h2 className="text-2xl font-semibold text-gray-900 tracking-tight">📋 All Listings</h2>
//           <p className="text-sm text-gray-500">Explore what's available from students across campus.</p>
//         </div>
...
//                 <div
//                   key={idx}
//                   className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-transform duration-200"
//                 >
...
//                         <span className="inline-block text-[11px] font-medium uppercase text-gray-500 bg-gray-100 px-2 py-0.5 rounded">
//                           {item.category}
//                         </span>
//                       </div>
...
//                       <span className={`text-xs font-medium inline-block px-3 py-1 rounded-full border ${item.status === 'sold' ? 'text-red-600 border-red-300' : 'text-green-600 border-green-300'}`}>
//                         {item.status === 'sold' ? '🔴 Sold' : '🟢 Available'}
//                       </span>

//                       {item.imageUrl && item.fileType === 'application/pdf' && (
//                         <iframe src={item.imageUrl} className="w-full h-48 mt-4 rounded-md border border-gray-200" title="PDF Document" />
//                       )}

//                       {item.imageUrl && !item.fileType?.startsWith('image/') && item.fileType !== 'application/pdf' && (
//                         <a href={item.imageUrl} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex items-center text-sm text-gray-700 hover:underline">
//                           📄 Download {item.fileName || 'file'}
//                         </a>
//                       )}

//                       {item.imageUrl && item.fileType?.startsWith('image/') && (
//                         <img src={item.imageUrl} alt={item.title} className="w-full mt-4 rounded-md border border-gray-200" />
//                       )}
...
//                             <button onClick={() => handleToggleStatus(item)} className="px-3 py-1 text-xs font-medium text-gray-800 border border-gray-300 rounded-md hover:bg-gray-100 hover:text-black transition">{item.status === 'sold' ? 'Mark as Available' : 'Mark as Sold'}</button>
//                           </div>
//                         ) : (
//                           <p className="text-sm text-gray-500 italic mt-2">You can view this post.</p>
//                         )}

//                         <button onClick={() => setMessageTarget(item)} className="w-full mt-2 px-4 py-2 text-sm font-medium text-white bg-black rounded-md hover:bg-gray-900 transition">
//                           📩 Contact Seller
//                         </button>
//                       </div>
//                     </>
...
//             {/* Google Book Results */}
//             <section className="mt-16 bg-white/70 backdrop-blur-md border border-gray-200 rounded-xl p-6 shadow-sm">
...
//     className="flex-1 w-full sm:w-96 px-4 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 transition"
//   />
//   <button
//     onClick={handleSearch}
//     className="px-5 py-2 text-sm font-medium text-white bg-black rounded-md shadow-sm hover:bg-gray-900 transition-colors"
//   >
//     Search
//   </button>
// </div>
...
//         <div
//           key={i}
//           className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition hover:-translate-y-1 p-5 flex flex-col"
//         >
//           {book.thumbnail && (
//             <img
//               src={book.thumbnail}
//               alt="Book Cover"
//               className="w-28 h-36 object-cover mx-auto rounded-md border border-gray-200 mb-4"
//             />
//           )}
//           <h3 className="font-medium text-base text-gray-900 mb-1 text-center">
//             {book.title}
//           </h3>
//           {book.authors && (
...
//               className="text-gray-700 hover:text-black underline underline-offset-2 transition"
//             >
//               Preview
//             </a>
...
//           className="px-5 py-2 text-sm font-medium bg-black text-white rounded-md hover:bg-gray-900 transition"
//         >
//           Load More
//         </button>
//       </div>
...
//                 <h2 className="text-sm font-semibold text-gray-900 mb-2">🧠 Recent Searches</h2>
//                 <ul className="list-disc pl-4 text-sm text-gray-600 space-y-1">
//                   {recentSearches.map((term, i) => (
//                     <li key={i}>{term.length > 40 ? term.slice(0, 40) + '…' : term}</li>
//                   ))}
//                 </ul>
//               </div>
//             )}
...
//   className="bg-white/80 backdrop-blur-md border border-gray-200 rounded-2xl shadow-sm max-w-2xl mx-auto px-8 py-10 space-y-6"
// >
...
//       onChange={handleChange}
//       required
//       className="w-full px-4 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 transition"
//     />
//   </div>
...
//       required
//       rows={4}
//       className="w-full px-4 py-2 text-sm border border-gray-300 rounded-md resize-none shadow-sm focus:outline-none focus:ring-1 focus:ring-gray-500 transition"
//     />
//   </div>
...
//     <button
//       type="submit"
//       className="inline-flex items-center gap-2 px-6 py-2 text-sm font-medium text-white bg-black rounded-md hover:bg-gray-900 transition shadow-sm"
//     >
//       Submit Request
//     </button>
//   </div>
...
//                 className="w-fit px-4 py-2 text-sm font-medium text-white bg-black rounded-md hover:bg-gray-900 transition"
//               >
//                 💬 Chat
//               </button>
//             </div>
